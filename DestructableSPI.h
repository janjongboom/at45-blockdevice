 ...
 */
 #ifndef DESTRUCTABLE_SPI_H
 #define DESTRUCTABLE_SPI_H
  ...
  * @ingroup drivers
  */
 class DestructableSPI : private NonCopyable<DestructableSPI> {
 ...
 protected:
     ...
     */
     ...
     static CircularBuffer<Transaction<DestructableSPI>, TRANSACTION_QUEUE_SIZE_SPI> _transaction_buffer;
 #endif
 ...
 #if DEVICE_SPI_ASYNCH
     CThunk<DestructableSPI> _irq;
     event_callback_t _callback;
     DMAUsage _usage;
 #endif

     void aquire(void);
     static DestructableSPI *_owner;
